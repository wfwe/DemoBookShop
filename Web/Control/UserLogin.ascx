<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.ascx.cs" Inherits="BookShop.Web.Control.UserLogin" %>
      ...
      <table height="61" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top" width="37%">
              &nbsp;<asp:TextBox ID="txtLoginId" runat="server" Width="150px"></asp:TextBox>
